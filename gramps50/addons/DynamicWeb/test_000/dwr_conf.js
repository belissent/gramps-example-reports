...
SVG_TREE_TYPES_NAMES = ["Ascending tree (horizontal)", "Ascending tree (vertical)", "Ascending tree (circle)", "Ascending tree (circle, proportional size)", "Ascending tree (half-circle, fixed size)", "Ascending tree (half-circle, proportional size)", "Descending tree (horizontal)", "Descending tree (horizontal, with spouses)", "Descending tree (vertical)", "Descending tree (vertical, with spouses)", "Descending tree (circle)", "Descending tree (circle, with spouses)", "Descending tree (half-circle)", "Descending tree (half-circle, with spouses)", "Ascending and descending tree (horizontal)", "Ascending and descending tree (horizontal, with spouses)", "Ascending and descending tree (vertical)", "Ascending and descending tree (vertical, with spouses)", "Ascending and descending tree (circle)", "Ascending and descending tree (circle, with spouses)", "Ascending and descending tree (circle, proportional size)", "Ascending and descending tree (circle, proportional size, with spouses)"];
SVG_TREE_TYPE = 14;
